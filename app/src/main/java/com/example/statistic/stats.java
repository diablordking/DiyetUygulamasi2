...
public class stats extends Fragment {
    ...
    public void onStart() {
        super.onStart();
        databaseReferenceCustomers = FirebaseDatabase.getInstance().getReference("report").child(mAuth.getUid());
        ...
        databaseReferenceCustomers.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot myDatasnaphot : dataSnapshot.getChildren()) {
                    Dater report = myDatasnaphot.getValue(Dater.class);
                    dp[index] = new DataPoint(report.getDate(), report.getCalorie().getCalorie());
                    index++;
                }
                series.resetData(dp);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Date date = new Date();
        final Date newDate = new Date(date.getTime() + (604800000L * 2) + (24 * 60 * 60));
